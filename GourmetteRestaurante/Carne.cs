...
{
    public partial class Carne : UserControl
    {
        List<Plato> lp = new List<Plato>();
        public Carne()
        {
            InitializeComponent();
            boton_plato_1.BackgroundImage = Image.FromFile("C:/Users/lolac/source/repos/GourmetteRestaurante/assets/platos/carne/carne_1.jpg");
            boton_plato_2.BackgroundImage = Image.FromFile("C:/Users/lolac/source/repos/GourmetteRestaurante/assets/platos/carne/carne_2.jpg");
            boton_plato_3.BackgroundImage = Image.FromFile("C:/Users/lolac/source/repos/GourmetteRestaurante/assets/platos/carne/carne_3.jpg");
            boton_plato_4.BackgroundImage = Image.FromFile("C:/Users/lolac/source/repos/GourmetteRestaurante/assets/platos/carne/carne_4.jpg");
        }
        ...
        public void guardarPLatos(List<Plato> lista_platos)
        {
            ...
            {
                if (p.getTipoPlato().Equals("Carne"))
                {
                    this.lp.Add(p);
                }
            }
