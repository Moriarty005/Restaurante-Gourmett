...
{
    public partial class Postres : UserControl
    {
        ...
        private void Postres_Load(object sender, EventArgs e)
        {

        }

        private void detalles_platos1_Load(object sender, EventArgs e)
        {
        ...
        public void guardarPLatos(List<Plato> lista_platos)
        {
            ...
            {
                if (p.getTipoPlato().Equals("Postre"))
                {
                    this.lp.Add(p);
                }
            }
