...
{
    public partial class Pescao : UserControl
    {
        ...
        public Pescao()
        {
            ...
            boton_plato_1.BackgroundImage = Image.FromFile("C:/Users/lolac/source/repos/GourmetteRestaurante/assets/platos/pescao/pescao_1.jpg");
            boton_plato_2.BackgroundImage = Image.FromFile("C:/Users/lolac/source/repos/GourmetteRestaurante/assets/platos/pescao/pescao_2.jpg");
            boton_plato_3.BackgroundImage = Image.FromFile("C:/Users/lolac/source/repos/GourmetteRestaurante/assets/platos/pescao/pescao_3.jpg");
            boton_plato_4.BackgroundImage = Image.FromFile("C:/Users/lolac/source/repos/GourmetteRestaurante/assets/platos/pescao/pescao_4.jpg");
        }

        private void Pescao_Load(object sender, EventArgs e)
        {
        ...
        public void guardarPLatos(List<Plato> lista_platos)
        {
            ...
            {
                if (p.getTipoPlato().Equals("Pescado"))
                {
                    this.lp.Add(p);
                }
            }
