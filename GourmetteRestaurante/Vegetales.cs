...
{
    public partial class Vegetales : UserControl
    {
        ...
        public Vegetales()
        {
            ...
            //this.lp = Form1.buscarPorTipoYDevolverPlatos("Vegetal");
            //Console.WriteLine("Valor de la longitud del array en el constructor: " + lp.Count);

            this.detalles_platos1.Visible = false;
        ...
        public void guardarPLatos(List<Plato> lista_platos)
        {
            ...
            {
                if (p.getTipoPlato().Equals("Vegetal"))
                {
                    this.lp.Add(p);
                }
            }
        ...
        private void Vegetales_Load(object sender, EventArgs e)
        {
